...
public final class JREUtils {
    ...
    private static void setRendererEnv(Map<String, String> envMap) {
        ...
        if (rendererId.startsWith("opengles2")) {
            ...
            // Zalith Remake FPS Boost: GL4ES performance optimizations
        ...
        if (!rendererId.startsWith("opengles")) {
            ...
            // Zalith Remake FPS Boost: Mesa/Zink performance optimizations
            envMap.put("MESA_GL_VERSION_OVERRIDE", "4.6");
            envMap.put("MESA_GLSL_VERSION_OVERRIDE", "460");
            envMap.put("MESA_GLSL_CACHE_DISABLE", "false");
            envMap.put("MESA_NO_ERROR", "1");
            envMap.put("GALLIUM_HUD", "");
    ...
    private static void initGraphicAndSoundEngine(boolean renderer) {
        ...
        // This MUST happen before any mod tries to load imgui native libs
