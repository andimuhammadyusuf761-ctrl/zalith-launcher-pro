...
class AllSettings {
    companion object {
        ...
        @JvmStatic
        val resolutionRatio = IntSettingUnit("resolutionRatio", 80)
        ...
        // Zalith Remake FPS Boost Settings
        @JvmStatic
        val fpsBoostMode = BooleanSettingUnit("fpsBoostMode", true)

        @JvmStatic
        val aggressiveGC = BooleanSettingUnit("aggressiveGC", true)

        @JvmStatic
        val reducedRenderDistance = BooleanSettingUnit("reducedRenderDistance", false)
